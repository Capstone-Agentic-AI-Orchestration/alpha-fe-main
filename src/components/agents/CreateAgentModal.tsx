...
import { AgentRole, ModelProvider, AgentAccessLevel } from '../../types';
...
export const CreateAgentModal: React.FC<CreateAgentModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleGenerateWithAI = async () => {
    ...
    let genModelName = 'claude-3-7-sonnet';
    ...
    if (promptLower.includes('review') || promptLower.includes('security')) {
      ...
      genModelName = 'claude-3-7-sonnet';
      ...
      genModelProv = 'Ollama';
      genModelName = 'llama3.3:70b-instruct-q8';
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (prov === 'Anthropic') setModelName('claude-3-7-sonnet');
                  else if (prov === 'OpenAI') setModelName('gpt-4o');
                  else if (prov === 'DeepSeek') setModelName('deepseek-r1:70b');
                  else if (prov === 'Ollama') setModelName('llama3.3:70b-instruct-q8');
                  else if (prov === 'LM Studio') setModelName('qwen2.5-coder:32b');
                  else if (prov === 'Google Gemini') setModelName('gemini-2.0-flash');
                }}
                className="w-full bg-surface-200 border border-white/10 rounded-lg px-3 py-2 text-xs text-white focus:outline-none focus:border-brand-500"
              >
