...
import { AlertCircle, Check, CheckCircle2, ChevronDown, Circle, Loader2, RotateCcw, Square } from 'lucide-react';
        ...
        <div>
          ...
          {logsOpen && (
            <div className="mt-2 space-y-1 bg-[#0D0E10] p-3 font-mono text-[10px] leading-relaxed text-gray-500">
              ...
              {run.changedFiles && <p>{run.changedFiles} files changed</p>}
            </div>
          )}
        </div>
      )}
