...
const ALL_TABS: { id: NavigationTab; title: string; subtitle: string; icon: React.ReactNode }[] = [
  { id: 'portal', title: 'Overview', subtitle: 'Your requests, progress, and budget', icon: <LayoutDashboard className="w-4 h-4 text-brand-400" /> },
  { id: 'intake', title: 'New Request', subtitle: 'Describe what you need in plain language', icon: <PenLine className="w-4 h-4 text-brand-400" /> },
  { id: 'documents', title: 'Specifications', subtitle: 'Requirement documents & acceptance criteria', icon: <FileText className="w-4 h-4 text-sky-400" /> },
  { id: 'estimates', title: 'Estimates', subtitle: 'Priced scope, ranges, and approval', icon: <Receipt className="w-4 h-4 text-emerald-400" /> },
  { id: 'billing', title: 'Billing & Usage', subtitle: 'Committed value, delivery cost, and margin', icon: <CreditCard className="w-4 h-4 text-amber-400" /> },
